...
<div class="input-group mb-3">
    <button type="button" class=" form-control btn btn-outline-primary " disabled><a href="Session1/index">Session1</a></button>
</div>
    <div class="input-group mb-3">
        <button type="button" class=" form-control btn btn-outline-primary " disabled><a href="Session2/index">Session2</a></button>
    </div>
<?php endif;?>
<div class="input-group mb-3">
